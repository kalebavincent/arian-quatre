...
async def broadcast_handler(m: Message):
    ...
    out = await m.reply_text(
        text=f"ʟᴀ ᴅɪꜰꜰᴜꜱɪᴏɴ ᴀ ᴄᴏᴍᴍᴇɴᴄé ! ᴠᴏᴜꜱ ʀᴇᴄᴇᴠʀᴇᴢ ᴜɴᴇ ɴᴏᴛɪꜰɪᴄᴀᴛɪᴏɴ ᴀᴠᴇᴄ ʟᴇ ꜰɪᴄʜɪᴇʀ ᴊᴏᴜʀɴᴀʟ ᴜɴᴇ ꜰᴏɪꜱ Qᴜᴇ ᴛᴏᴜꜱ ʟᴇꜱ ᴜᴛɪʟɪꜱᴀᴛᴇᴜʀꜱ ᴀᴜʀᴏɴᴛ éᴛé ɴᴏᴛɪꜰɪéꜱ."
    )
    ...
    if failed == 0:
        await m.reply_text(
            text=f"ʙʀᴏᴀᴅᴄᴀsᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ {completed_in}\n\nᴛᴏᴛᴀʟ ᴜsᴇʀs {total_users}.\nᴛᴏᴛᴀʟ ᴅᴏɴᴇ {done}, {success} sᴜᴄᴄᴇss ᴀɴᴅ {failed} ꜰᴀɪʟᴇᴅ",
            quote=True
        )
    else:
